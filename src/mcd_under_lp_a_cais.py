...
def evolve_underdamped_lp_a_cais(
    z,
    betas,
    params,
    rng_key_gen,
    ...
    def evolve(aux, i, stable=True):
        ...
        fk_rho_mean = rho * (1.0 - eta_aux) - 2.0 * eta_aux * apply_fun_sn(
            params["sn"], input_sn_old, i
        )
        ...
        bk_rho_mean = rho_prime * (1.0 - eta_aux) + 2.0 * eta_aux * apply_fun_sn(
